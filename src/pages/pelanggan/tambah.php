...
if (isset($_POST['submit'])) {
    ...
    $query = mysqli_query($connect, "INSERT INTO pelanggan (NamaPelanggan, Alamat, NomorTelepon) VALUES ('$nama', '$alamat', '$telepon')");
    
    if ($query) {
        echo "<script>alert('Data pelanggan berhasil ditambahkan'); window.location.href='index.php?page=pelanggan';</script>";
    } else {
